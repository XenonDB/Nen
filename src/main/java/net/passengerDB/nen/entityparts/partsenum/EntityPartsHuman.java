...
public class EntityPartsHuman extends EntityPartsManager {
	...
	public void createParts() {
		Entity h = getHost();
		this.parts.put(EnumEntityPartType.ARM, new EntityPart[] {new EntityPart(this), new EntityPart(this)});
		this.parts.put(EnumEntityPartType.LEG, new EntityPart[] {new EntityPart(this), new EntityPart(this)});
		this.parts.put(EnumEntityPartType.HEAD, new EntityPart[]{new EntityPart(this,false,true)});
